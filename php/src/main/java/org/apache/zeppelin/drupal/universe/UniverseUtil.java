...
/**
 * Util class for convert request from Zeppelin to Drupal
 */
public class UniverseUtil {
  ...
  public UniverseQuery convertQuery(String text, UniverseClient client, String token)
    ...
    if(!text.startsWith("query:")) {
    	UniverseQuery universeScript = new UniverseQuery(text,universeInfo, duplicatedRows, limit);
    	return universeScript;
    }
    else {
