DROP TABLE IF EXISTS hosp.flow_project;
CREATE TABLE hosp.flow_project (
  id varchar(64) NOT NULL COMMENT 'ID',
  name varchar(100) NOT NULL COMMENT '项目名称',
  PRIMARY KEY (id)
);

DROP TABLE IF EXISTS hosp.flow_node;
CREATE TABLE hosp.flow_node (
  id varchar(64) NOT NULL COMMENT 'ID',
...
DROP TABLE IF EXISTS hosp.flow_line;
CREATE TABLE hosp.flow_line (
  id varchar(64) NOT NULL COMMENT 'ID',
  project_id varchar(64) NOT NULL COMMENT '项目ID',
