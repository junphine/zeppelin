...
public class GroovyCompleter {
  ...
  public int completeSQL(String buffer, int cursor, List<InterpreterCompletion> candidates) {
  ...
  public static Set<String> getSqlKeywordsCompletions(DatabaseMetaData meta) throws IOException,
    ...
    String keywords =
            new BufferedReader(new InputStreamReader(
                    GroovyCompleter.class.getResourceAsStream("/ansi.sql.keywords"))).readLine();
    ...
    if (null != meta) {
      ...
      try {
        if (GroovyCompleter.class.getResource(driverSpecificKeywords) != null) {
          String driverKeywords =
                  new BufferedReader(new InputStreamReader(
                          GroovyCompleter.class.getResourceAsStream(driverSpecificKeywords)))
                          .readLine();
