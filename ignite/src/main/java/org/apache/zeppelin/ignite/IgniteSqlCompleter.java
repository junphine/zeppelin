 ...
 */
public class IgniteSqlCompleter {
  private static Logger logger = LoggerFactory.getLogger(IgniteSqlCompleter.class);
  ...
  public IgniteSqlCompleter(Connection conn,int ttlInSeconds) {
  ...
  public static Set<String> getSqlKeywordsCompletions(DatabaseMetaData meta) throws IOException,
    ...
    String keywords =
            new BufferedReader(new InputStreamReader(
                    IgniteSqlCompleter.class.getResourceAsStream("/ansi.sql.keywords"))).readLine();
    ...
    if (null != meta) {
      ...
      try {
        if (IgniteSqlCompleter.class.getResource(driverSpecificKeywords) != null) {
          String driverKeywords =
                  new BufferedReader(new InputStreamReader(
                          IgniteSqlCompleter.class.getResourceAsStream(driverSpecificKeywords)))
                          .readLine();
